...
<div class="app-wrap">
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li><a href="page7-gestion-employes.html"><i class="bi bi-people"></i> Employés</a></li>
  ...
  <div class="main">
    <div class="topbar">
      ...
      <div class="topbar-actions">
        <a href="page7-gestion-employes.html" class="btn-forest" style="padding:7px 14px;font-size:.82rem"><i class="bi bi-person-plus"></i> Ajouter un employé</a>
      </div>
    </div>
      ...
      <div style="display:grid;grid-template-columns:1fr 320px;gap:1.5rem;align-items:start">
        ...
        <div class="data-card" style="margin:0">
          <div class="data-card-head">
            ...
            <a href="page5-liste-rh.html" style="font-size:.8rem;color:var(--forest);text-decoration:none">Tout voir →</a>
          </div>
          <table class="tbl">
            <thead>
