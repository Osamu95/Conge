...
<div class="app-wrap">
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-nav" style="margin-top:1rem">
      ...
      <li><a href="page3-form-conge.html" class="active"><i class="bi bi-plus-circle"></i> Nouvelle demande</a></li>
      <li><a href="page4-mes-conges.html"><i class="bi bi-calendar3"></i> Mes demandes</a></li>
