...
<div class="app-wrap">
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-nav" style="margin-top:1rem">
      <li><a href="page6-dashboard-admin.html"><i class="bi bi-speedometer2"></i> Vue d'ensemble</a></li>
      <li><a href="page5-liste-rh.html"><i class="bi bi-inbox"></i> Toutes les demandes</a></li>
      <li><a href="page7-gestion-employes.html" class="active"><i class="bi bi-people"></i> Employés</a></li>
